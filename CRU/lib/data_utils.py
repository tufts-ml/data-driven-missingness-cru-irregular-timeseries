...
def load_data(args):
    ...
    train_dl = DataLoader(train, batch_size=args.batch_size, shuffle=False, collate_fn=collate_fn, num_workers=args.num_workers, pin_memory=args.pin_memory)
    valid_dl = DataLoader(valid, batch_size=len(valid.data), shuffle=False, collate_fn=collate_fn, num_workers=args.num_workers, pin_memory=args.pin_memory)
