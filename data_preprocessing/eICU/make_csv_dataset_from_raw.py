...
if __name__ == '__main__':
    ...
    labs_df = pd.read_csv('eicu_v2.0/lab.csv.gz') # make sure the data is downloaded from https://physionet.org/content/eicu-crd/2.0/ into the folder eicu_v2.0
    
    labs_df.rename(columns={'patientunitstayid': 'icustay_id'}, inplace=True)
    
    
    print('Getting patient info...')
    patient_df = pd.read_csv('eicu_v2.0/patient.csv.gz')
